...
def callback(data):
    ...
    rospy.loginfo("This is the loc of %s  : X : %f , Y : %f , Z : %f", data.uxvs[index].name, data.uxvs[index].pose.position.x, data.uxvs[index].pose.position.y, data.uxvs[index].pose.position.z)
    counter = 0
    for x in turns:
...
if __name__ == "__main__":
    ...
    try:
        ...
        result = request(uxv_name)
        print("BAYBAYBAYBAYBAYBAYBAYBAYBAYBABABYABAYBABYABAYB")
